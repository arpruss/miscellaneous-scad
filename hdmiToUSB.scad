...
module hdmiOverhang() {
    translate([0,0,bottomHeight+wall-hdmiHoleDiameter/2]) overhang(radius=hdmiHoleDiameter/2,stickout=hdmiHoleDiameter/2);
}
...
module hdmiCutout() {
    translate([0,0,bottomHeight+wall-hdmiHoleDiameter/2]) rotate([90,0,0]) {
